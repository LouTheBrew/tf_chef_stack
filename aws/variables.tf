...
#
variable "as_flavor" {}
variable "as_hostname" {}
#
# tf_chef_supermarket
#
variable "ss_flavor" {}
variable "ss_hostname" {}
#
# tf_chef_compliance
#
variable "cmp_flavor" {}
variable "cmp_hostname" {}
variable "cmp_license" {}
#
# tf_chef_delivery
#
variable "ds_enterprise" {}
variable "ds_flavor" {}
variable "ds_hostname" {}
variable "ds_license" {}
#
# tf_chef_delivery_build
#
variable "dbs_basename" {}
variable "dbs_count" {}
variable "dbs_flavor" {}
